...
describe("addTransaction", () => {
  ...
  it("Succeds adding a transaction", () =>{
    ...
    .then(userData => {
      userId = userData.id
      return logic.addTransaction(userId, "XRPUSDT", "BUY", 1000, 0.1, "2026-04-24T00:00:00Z")
    })
  ...
  it("Fails on non-existing user", ()=> {
    let caught = null
    return logic.addTransaction("111111112222222233333333","XRPUSDT", "BUY", 1000, 0.1, "2026-04-24T00:00:00Z")
