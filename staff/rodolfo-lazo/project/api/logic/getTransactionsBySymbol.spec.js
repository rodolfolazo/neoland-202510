...
describe('getTransactionsBySymbol', () => {
  ...
  it('Success getting all transactions from a specified crypto', () =>{
    ...
    .then(userData =>{
      ...
      return data.insertTransaction(
        new TransactionData(null, userId, "XRPUSDT", "BUY", 1000, 0.1, 1000*0.1, "2026-04-24T00:00:00Z", 1000))
    })
    .then(() => data.insertTransaction(
  ...
  it('Fails on non-existing user', () =>{
    ...
    .then(() => data.insertTransaction(
      new TransactionData(null, userId, "XRPUSDT", "BUY", 3000, 0.1, 1000*0.1, "2026-04-24T01:00:00Z", 4000)))
    .then(() => logic.getTransactionsBySymbol("111111112222222233333333", "XRPUSDT"))
