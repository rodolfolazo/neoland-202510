    ...
    <>
      <Routes>
          ...
          element={
            !loggedIn ? (
              ...
              <Home
                ...
                onUserLoggedOut={handleGoToLogin}
        ...
        <Route
          ...
          element={
            loggedIn ? (
              <AddPet onGoToHome={handleGoToHome} />
            ) : (
              <Navigate to="/login" />
            )
          }
        ...
        <Route
          path="/pets/:petId/detail"
          element={
            loggedIn ? (
              <PetDetail
                onGoToHome={handleGoToHome}
                onGoToModifyPet={handleGoToModifyPet}
              />
            ) : (
              <Navigate to="/login" />
            )
        ...
        <Route
          ...
          element={
            loggedIn ? (
              <ModifyPet onGoBack={handleGoToPetDetail} />
            ) : (
              <Navigate to="/login" />
            )
          }
